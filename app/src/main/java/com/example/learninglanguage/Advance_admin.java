...
public class Advance_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refVideo= FirebaseDatabase.getInstance().getReference().child("video");
    ...
    private void uploadFile() {
        if(videoUri!=null)
        {
            ...
            final StorageReference storageReference=mstorageref.child(System.currentTimeMillis()+"."+getFileExtension(videoUri));
            int durationInMillis=findSongDuration(videoUri);
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            String uploadId=refVideo.push().getKey();
                            refVideo.child(uploadId).setValue(uploadSong);
